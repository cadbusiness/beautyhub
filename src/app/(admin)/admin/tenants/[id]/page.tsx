...
export default async function TenantDetailPage({
 ...
 <h2 className="font-medium text-slate-900">Informations</h2>
 ...
 <Card className="space-y-4">
 <h2 className="font-medium text-slate-900">Usage rendez-vous</h2>
 ...
 <Card className="space-y-4">
 <h2 className="font-medium text-slate-900">Abonnement</h2>
 ...
 <Card>
 <h2 className="font-medium text-slate-900">Equipe</h2>
