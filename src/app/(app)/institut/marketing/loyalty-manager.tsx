    ...
    <div className="space-y-6">
      <div className="px-4 pt-4 lg:px-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4">
            <p className="text-xs font-medium uppercase tracking-wide text-slate-500">
              {t("stats.pointsOutstanding", { label: program.points_label })}
            </p>
            <p className="mt-2 text-2xl font-semibold tabular-nums text-slate-900">
      ...
      <ListPanel className="flex-none">
        <div className="border-b border-slate-200 px-4 py-4 lg:px-6">
          <h2 className="text-sm font-semibold text-slate-900">{t("program.title")}</h2>
          <p className="mt-1 text-sm text-slate-500">{t("program.description")}</p>
        </div>
      ...
      <ListPanel className="flex-none">
        ...
        <p className="border-t border-slate-200 px-4 py-3 text-xs text-slate-500 lg:px-6">
