...
define('BEAUTYHUB_CONNECTOR_VERSION', '1.5.0');
...
require_once BEAUTYHUB_CONNECTOR_PATH . 'includes/class-beautyhub-promos.php';
require_once BEAUTYHUB_CONNECTOR_PATH . 'includes/class-beautyhub-gift-cards.php';
...
add_action('plugins_loaded', function () {
    ...
    BeautyHub_Promos::init();
    BeautyHub_Gift_Cards::init();
});
