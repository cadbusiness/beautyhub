...
export function CategoriesDialog({
  ...
  const t = useTranslations("institut.services.categories");
  ...
  const [editState, editAction, editPending] = useActionState(updateServiceCategory, initial);
      ...
      <div className="space-y-5">
        ...
        <form action={createAction} className="flex flex-wrap items-end gap-2">
          <div className="min-w-[12rem] flex-1">
            <Field label={t("name")} htmlFor="new_category_name">
              <Input
          ...
          <div className="w-24">
            <Field label={t("sortOrder")} htmlFor="new_category_sort">
              <Input id="new_category_sort" name="sort_order" type="number" defaultValue={0} />
            </Field>
          </div>
