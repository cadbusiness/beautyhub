...
export function BookingWizard() {
 ...
 <span
 key={s}
 className={step >= s ? "font-medium text-slate-900" : ""}
 >
 Etape {s}
 </span>
 ))}
 ...
 <h2 className="font-medium text-slate-900">Choisir une prestation</h2>
 {services.length === 0 ? (
 ...
 {step === 2 ? (
 <Card className="space-y-3">
 <h2 className="font-medium text-slate-900">Choisir un praticien</h2>
 {staff.map((s) => (
 <button
 key={s.id}
 type="button"
 ...
 <h2 className="font-medium text-slate-900">Choisir une date</h2>
 ...
 {step === 4 ? (
 <Card className="space-y-4">
 <h2 className="font-medium text-slate-900">Choisir un creneau</h2>
 {slots.length === 0 ? (
